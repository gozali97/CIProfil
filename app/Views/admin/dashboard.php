                ...
                <div class="card-body">
                    ...
                    <div class="row mt-3">
                        <div class="col-6 pe-1">
                            ...
                            <img src="{{ asset('admin/assets/images/dashboard/img_4.jpg') }}" class="mw-100 w-100 rounded"
                                alt="image">
                        </div>
                    ...
                    <div class="d-flex mt-5 align-items-top">
                        <img src="{{ asset('admin/assets/images/faces/face3.jpg') }}" class="img-sm rounded-circle me-3"
                            alt="image">
